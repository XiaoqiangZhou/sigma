...
from inpainting.saicinpainting.training.modules.base import get_activation, BaseDiscriminator
# from inpainting.saicinpainting.training.modules.spatial_transform import LearnableSpatialTransformWrapper
from inpainting.saicinpainting.training.modules.squeeze_excitation import SELayer
from inpainting.saicinpainting.utils import get_shape
...
class FFCResNetGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64, n_downsampling=3, n_blocks=9, norm_layer=nn.BatchNorm2d,
                 ...
                 init_conv_kwargs={'ratio_gin':0, 'ratio_gout':0}, downsample_conv_kwargs={'ratio_gin':0, 'ratio_gout':0}, resnet_conv_kwargs={'ratio_gin':0.75, 'ratio_gout':0.75},
